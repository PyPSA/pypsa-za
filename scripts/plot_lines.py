...
## DATA
    ...
    l1 = l1_1 = ax.legend(handles, labels,
                loc="upper left", bbox_to_anchor=(0.35,2),#(0.24, 1.01),
                frameon=False,
    ...
    l1_2 = ax.legend(handles, labels,
                loc="upper left", bbox_to_anchor=(0.25,1.1),#(0.26, 1.01),
                frameon=False,
    ...
    l2 = ax.legend(handles, labels,
                loc="upper left", bbox_to_anchor=(0.35,2),#(0.01, 1.01),
    ...
    # l3 = ax.legend(handles, labels, loc="lower left",  bbox_to_anchor=(0.6, -0.5), # bbox_to_anchor=(0.72, -0.05),
...
if __name__ == "__main__":
    if 'snakemake' not in globals():
        ...
        snakemake = mock_snakemake('plot_network', **{'model_file':'za-original',
                            'regions':'10-supply',
                            'resarea':'redz',
                            'll':'copt',
                            'opts':'LC',
    ...
    n = load_network_for_plots(
        '../results/version-0.6/networks/elec_s_10_ec_lcopt_Co2L-4H.nc', snakemake.input.model_file, config, model_setup.costs
